      ...
      <div className="max-w-7xl mx-auto px-8 py-5">
        <div className="flex items-center">
          ...
          <div className="flex items-center gap-3">
            <Zap className="size-7" style={{ color: isDark ? '#60A5FA' : '#6366F1' }} />
            <span className="text-[20px] font-bold tracking-wide" style={{ color: isDark ? '#FFFFFF' : '#1F2937' }}>
               AUCTION HOUSE
            </span>
          </div>
          {/* Center Tabs */}
                ...
                return (
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-lg transition-all font-medium hover:opacity-90"
                      style={{
                        backgroundColor: isDark ? 'rgba(91, 127, 255, 0.18)' : '#E0E7FF',
                        color: isDark ? '#E5E7EB' : '#1F2937',
                        border: isDark ? '1px solid rgba(91,127,255,0.35)' : '1px solid #C7D2FE'
                      }}
                    >
                      {account?.displayName}
                    </button>
